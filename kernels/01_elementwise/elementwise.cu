...
/**
 * ================================ Warp 介绍 =======================================
 * 查看 GPU 完整信息: nvidia-smi -q, 里面有频率/各层级内存大小/甚至温度, 但是没找到 thread 信息
 * torch 接口:
 * @code
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("elementwise_add", &elementwise_add, "Elementwise add of two tensors");
}
